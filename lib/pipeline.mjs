...
export async function runRefresh() {
  ...
  const meta = {
    ...
    market_count: marketInventory.records.length,
    cities: [...new Set(retained.map((lead) => lead.source_city))],
    apify,
    propertyRadar,
    marketInventory: marketInventory.meta,
    warnings
  };
  ...
  await fs.writeFile(MARKET_PATH, JSON.stringify(marketInventory.records, null, 2));
